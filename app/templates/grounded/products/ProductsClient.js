    ...
    <main className={s.page}>
      <header className={s.header}>
        <nav className={`${s.wrap} ${s.nav}`}>
          <Link href="/templates/grounded" className={s.logo}>
            MVIA<span>.</span>
          </Link>
          <div className={s.navlinks}>
            <Link href="/templates/grounded#method">Method</Link>
            <Link href="/templates/grounded#programs">Programs</Link>
            <Link href="/templates/grounded#about">About</Link>
            <Link href="/templates/grounded#contact">Contact</Link>
          </div>
      ...
      <footer className={s.footer}>
        &copy; 2026 THE MVIA INC. All rights reserved. &middot; Product demo &mdash; Grounded
      </footer>
    </main>
  );
}
